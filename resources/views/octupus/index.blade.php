                ...
                <header class="page-header">
                    ...
                    <div class="right-wrapper pull-right">
                        <ol class="breadcrumbs">
                            <li>
                                <a href="{{URL::asset('/octopus/index')}}">
                                            ...
                                            <li>
                                                <div class="tm-box">
                                                    ...
                                                    <div class="thumbnail-gallery">
                                                        <a class="img-thumbnail lightbox" href="{{URL::asset('images/projects/project-4.jpg')}}" data-plugin-options='{ "type":"image" }'>
                                                            <img class="img-responsive" width="215" src="{{URL::asset('images/projects/project-4.jpg')}}">
                                                            <span class="zoom">
