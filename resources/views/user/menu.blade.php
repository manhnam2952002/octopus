        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    <li class="nav-active">
                        <a href="{{URL::asset('/octupus/index')}}">
                    ...
                    <li class="nav-parent">
                        ...
                        <ul class="nav nav-children">
                            ...
                            <li>
                                <a href="{{URL::asset('/octupus/calendar')}}">
                                    Calendar
                                </a>
                            </li>
                            <li>
                    ...
                    <li class="nav-parent">
                        ...
                        <ul class="nav nav-children">
                            ...
                            <li>
                                <a href="{{URL::asset('/octupus/ui-elements-modals')}}">
                                    Modals
                                </a>
                            </li>
                            <li>
                    ...
                    <li class="nav-parent">
                        ...
                        <ul class="nav nav-children">
                            ...
                            <li>
                                <a href="{{URL::asset('/octupus/forms')}}">
                                    Advanced
                                </a>
                            </li>
                            <li>
